...
Next, we will create an estimation model in order to classify beers (IPA vs. Non-IPA) based on their alchol and IBU levels. The first steps are preparing the data by splitting and classifying accordingly.
```{r}
